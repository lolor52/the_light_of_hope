...
- tickers_filling: анализ тикеров для выбора наиболее подходящих инструментов к предстоящей торговой сессии; формулы индексов ликвидности, волатильности и «плоского» тренд-фильтра смотрите в `docs/formulas_tickers_selection.md`.
