...
- `internal/auth`: слой абстракций для аутентификации; прежний подмодуль MOEX Passport удалён.
...
- `internal/a_submodule/moex`: каталог оставлен пустым; функциональность удалена.
