...
- `internal/a_submodule/moex`: клиенты MOEX Passport и ISS с авторизацией через Passport.
- `internal/a_submodule/indicators`: расчёт VAH/VAL/VWAP по данным основной торговой сессии MOEX.
